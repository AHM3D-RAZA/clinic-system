...
export const APPOINTMENTS: Appointment[] = [
  ...
  { id: "apt_0016", clinicId: "aster", patientName: "Layla Haroon", patientType: "new", doctorId: DOCTOR.sana, serviceId: SERVICE.kids, date: daysFromTodayIso(1), time: "10:15", durationMinutes: 30, status: "pending" },
  { id: "apt_0017", clinicId: "aster", patientName: "Ethan Brooks", patientType: "existing", doctorId: DOCTOR.nadia, serviceId: SERVICE.checkups, date: daysFromTodayIso(1), time: "13:00", durationMinutes: 30, status: "confirmed" },

  // Two days ahead
  { id: "apt_0018", clinicId: "aster", patientName: "Rohan Vidal", patientType: "new", doctorId: DOCTOR.sana, serviceId: SERVICE.kids, date: daysFromTodayIso(2), time: "09:30", durationMinutes: 30, status: "confirmed" },
  { id: "apt_0019", clinicId: "aster", patientName: "Mahnoor Khan", patientType: "existing", doctorId: DOCTOR.rehan, serviceId: SERVICE.fillings, date: daysFromTodayIso(2), time: "11:00", durationMinutes: 45, status: "pending" },

  // Three days ahead
  { id: "apt_0020", clinicId: "aster", patientName: "Sophia Larkin", patientType: "new", doctorId: DOCTOR.nadia, serviceId: SERVICE.ortho, date: daysFromTodayIso(3), time: "14:00", durationMinutes: 45, status: "confirmed" },
];
